...
@section('content')
    <section class="container py-4">
        ...
        <div class="mb-4">
            ...
            <p class="text-muted">Hasil perhitungan status antropometri dan logika fuzzy Mamdani (data belum disimpan ke
                sistem).</p>
        </div>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-5 col-md-12">
                ...
                <div class="card result-card p-4">
                    ...
                    <p class="small text-muted mb-4">Data di bawah ini merupakan simulasi kalkulasi. Anda dapat kembali
                        mengedit input atau menyimpannya.</p>
                    <div class="d-grid gap-2">
                        ...
                        <a href="{{ route('analisis-fuzzy.create') }}" id="btn_edit_input"
                            class="btn btn-outline-secondary py-2.5 fw-semibold rounded-3">
            ...
            <div class="col-lg-7 col-md-12">
                ...
                <div class="card result-card p-4 mb-4">
                    <h5 class="fw-bold text-success mb-3"><i class="fa-solid fa-calculator me-2"></i>Hasil Klasifikasi
                        Antropometri (Z-Score)</h5>
                    <hr class="mt-0 mb-3 text-muted">
                ...
                <div class="card result-card p-4">
                    <h5 class="fw-bold text-success mb-3"><i class="fa-solid fa-gears me-2"></i>Hasil Perhitungan Logika
                        Fuzzy (Mamdani)</h5>
                    <hr class="mt-0 mb-3 text-muted">
                    ...
                    <h6 class="fw-bold text-dark mb-2"><i class="fa-solid fa-list-check me-2 text-success"></i>Aturan Fuzzy
                        (Rule) yang Aktif</h6>
...
@push('script')
    ...
    <script>
        $(document).ready(function () {
            let isLeavingSafely = false;

            window.addEventListener('beforeunload', function (e) {
                if (!isLeavingSafely && sessionStorage.getItem('fuzzy_result') && sessionStorage.getItem('fuzzy_input')) {
                    e.preventDefault();
                    e.returnValue = 'Hasil analisis belum disimpan, yakin keluar?';
                    return e.returnValue;
                }
            });

            // Allow safe navigation on clicking "Edit Input"
            $('#btn_edit_input').click(function () {
                isLeavingSafely = true;
            });
                        ...
                        $.ajax({
                            ...
                            error: function (xhr) {
                                ...
                                if (xhr.status === 422 && xhr.responseJSON.errors) {
                                    // Ambil pesan error pertama yang digagalkan oleh Laravel
