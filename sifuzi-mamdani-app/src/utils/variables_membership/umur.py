...
def hitung_derajat_fase_umur(umur_tahun: float) -> dict:
    ...
    berdasarkan rumus dari Kelompok 9 dengan pinggir trapesium separuh.
    """
    x = umur_tahun
    
    return {
        "Fase1": kurva_trapesium_kiri(x, a=6.0, b=12.0),
        ...
        "Fase5": kurva_trapesium_kanan(x, a=24.0, b=42.0),
    }